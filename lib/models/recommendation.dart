...
final List<Recommendation> demo_recommendations = [
  Recommendation(
    ...
    source: "Linkedin",
    text:
    "I have had the pleasure of working with Abdallah aid on java projects and what strikes me the most about his work is his ability to write clean and reusable codes with best practices. He is hardworking and makes it so easy to transcribe ideas into beautiful and testable flutter apps. He is a Flutter/Dart gem and has my highest recommendation",
  ),
  Recommendation(
    name: "Mohamed",
    source: "Youtube",
    text:
    "Osaama el zero is great . It's a true pleasure working with him at TakeIn. His web school skill is amazing as well as his professionalism and being a good team player. Osmama problem solving skill is also one of his great skills.",
  ),
  Recommendation(
    name: "Ali",
    source: "YouTube",
